...
N(capacity), n(0)                                                                                           /* The building is initially empty */
{
...
const bool Building::Enter(Visitor& visitor) {
  if (n < N) {                                                                               /* Check if there is enough space in the building */
    if (g.Enter(visitor)) {                                                   /* Visitor must access the ground in order to enter the building */
      n++;                                                                             /* Increase by 1 the number of visitors in the building */
...
void Building::Exit(const Visitor& visitor) {
  ...
  n--;                                                                                 /* Decrease by 1 the number of visitors in the building */
}
