...
class Floor {
  Entrance e;                                                           /* Floor has an entrance */
  ...
  unsigned int nf;                                   /* Current number of visitors in this floor */
  const unsigned int Nf;                             /* Maximum number of visitors in this floor */
