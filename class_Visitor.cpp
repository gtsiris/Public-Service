...
const bool Visitor::operator==(const Visitor& visitor) const {
  return (this->Get_dest_floor() == visitor.Get_dest_floor() && this->Get_dest_office() == visitor.Get_dest_office() 
  && this->Get_priority() == visitor.Get_priority() && this->Get_status() == visitor.Get_status());
